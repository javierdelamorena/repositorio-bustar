...
import com.springcloud.msvc.users.services.IUserService;
...
public class UserController {
    ...
    public ResponseEntity<User> registrarser(@RequestBody User user) {
        return new ResponseEntity<>(userService.save(user), HttpStatus.CREATED);
    }

    @PutMapping("/{id}")
    public ResponseEntity<User> updateUser(@RequestBody User user, @PathVariable Long id) {
    	logger.info("Entramos en el updateUser el iod es: "+id);
    ...
    public ResponseEntity<User> getUserById(@PathVariable Long id) {
    	logger.info("Entramos en el getUserByid: "+id);
